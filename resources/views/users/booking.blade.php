                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" id="email" class="form-control" required placeholder="example@gmail.com">
                            </div>
                            <div class="mb-3">
                                <label for="email">Retype Your Email <span class="text-danger">*</span></label>
                                <input type="text" name="validateEmail" id="retypeEmail" class="form-control" required placeholder="retype and check your email">
